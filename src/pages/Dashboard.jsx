  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-2xl font-medium mb-6 bg-gradient-to-br from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden">
          Welcome, Spoorthi
        </p>
        ...
        {showCreateResume && (
          <form onSubmit={createResume} onClick={() => setShowCreateResume(false)} className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center">
            ...
            <div onClick={e => e.stopPropagation()} /*This is the actual popup box in the center containing input fields and buttons.*/
              ...
              <button
                className="w-full py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors">Create Resume</button>
            ...
            <div onClick={e => e.stopPropagation()} 
              ...
              <input onChange={(e)=>setTitle(e.target.value)} value={title}
                ...
                <div className='flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-green-500 hover:text-green-700 cursor-pointer transition-colors'>
                  ...
                  <input type="file" id="resume-input" accept=".pdf" hidden onChange={(e)=>setResume(e.target.files[0])}/>{/*This stores the selected file (only PDFs allowed) in the resume*/}
