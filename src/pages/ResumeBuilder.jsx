...
function ResumeBuilder() {
  ...
  const { resumeId } = useParams()//useParams() is a React Router hook that lets you read URL parameters from the current route.
  ...
  {/*Looks for a resume in dummyResumeData that matches the given resumeId.
If found, it sets it as the current resume (setResumeData(resume)).
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              {/*Section Navigation*/}
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'><div></div>
