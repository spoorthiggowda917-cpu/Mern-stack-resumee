  ...
  return (
    <div className='relative'>
      <button
        ...
        className='flex items-center gap-1 text-sm text-blue-600 bg-linear-to-br from-blue-50 to-blue-100 ring-1 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'
      >
        <Layout size={14} />
